...
class DataModule(LightningDataModule):
    ...
    def prepare_data(self):
        ...
        if self.dataset_name == 'IMAGENET':
            datasets.IMAGENET(self.data_dir, train=True, download=True)
            datasets.IMAGENET(self.data_dir, train=False, download=True)
    ...
    def setup(self, stage=None):
        ...
        if stage == "fit" or stage is None:
            ...
            if self.dataset_name == 'IMAGENET':
                self.train_dataset = datasets.IMAGENET(self.data_dir, train=True, transform=self.transform)
                self.val_dataset = self.train_dataset
